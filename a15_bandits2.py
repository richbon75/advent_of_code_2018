...
while elfattack_min < elfattack_max:
    # print('Range: ', elfattack_min, elfattack_max)
    tryattack = (elfattack_min + elfattack_max) // 2
    result = elfsurvive(tryattack)
    if result:
        last_successful_result = result
        elfattack_max = tryattack
    else:
        elfattack_min = tryattack
    if elfattack_min == elfattack_max - 1:
        break
# print('Final Range: ', elfattack_min, elfattack_max)
print(f'Perfect Elf attack found: {elfattack_max}')
